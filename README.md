...
This repository automates most of the process of keeping our [Ubuntu Desktop VM images](https://app.vagrantup.com/ProfessorManhattan/boxes/Base-Ubuntu-Desktop) up-to-date with the latest upstream source by:
